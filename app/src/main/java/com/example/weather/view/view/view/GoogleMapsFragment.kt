...
import com.example.weather.databinding.FragmentMapsSearchBinding
...
class GoogleMapsFragment : Fragment() {
    ...
    private var _binding: FragmentMapsSearchBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMapsSearchBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun activateMyLocation(googleMap: GoogleMap) {
        val isPermissionGranted = ContextCompat.checkSelfPermission(requireContext(), android.Manifest.permission.ACCESS_FINE_LOCATION) ==
